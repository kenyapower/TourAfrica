...
<head>
    <meta charset="UTF-8">
    <title>Request Account | TourAfrica</title>
                    ...
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <form>
                                ...
                                <div class="form-outline mb-4">
                                    <input type="number" id="form3Example4cg" name="phone" class="form-control form-control-lg" />
                                    <label class="form-label" for="form3Example4cg">Phone Number</label>
                                </div>


                                <div class="form-check d-flex justify-content-center mb-5">
                                    <p><input class="form-check-input me-2" type="checkbox" name="t.o.s" value="Yes" id="form2Example3cg" required/> </p>
