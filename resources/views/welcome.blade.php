...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <h3 class="my-0 mr-md-auto font-weight-normal">TourAfrica</h3>
{{--    <img src="img/van6.jpg" height="100"/>--}}
    <nav class="my-2 my-md-0 mr-md-3">
        <a class="p-2 text-dark tablink" onclick="openPage('index', this, 'greenyellow')" id="defaultOpen">Home</a>
        <a class="p-2 text-dark tablink" onclick="openPage('about', this, 'greenyellow')" >About</a>
        <a class="p-2 text-dark tablink" onclick="openPage('contact', this, 'greenyellow')">Contact</a>
        <a class="p-2 text-dark tablink" onclick="openPage('operation', this, 'greenyellow')">Operations</a>
    </nav>
    <a class="btn btn-outline-primary" href="login">Sign in/up</a>
</div>
...
<div id="about" class="tabcontent">
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 500px;" src="img/vans.jpg" data-holder-rendered="true">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 500px;" src="img/pic7.jpg" data-holder-rendered="true">
            </div>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="img/pic3.jpg" data-holder-rendered="true" style="width: 500px; height: 500px;">
            </div>
        </div>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="img/specials-3.png" data-holder-rendered="true" style="width: 500px; height: 500px;">
            </div>
        </div>
...
<footer class="text-center text-white" style="background-color: #caced1;">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
                    <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                        <img src="img/pic4.jpg" height="100" width="200" class="w-100"/>
                        <a href="#!">
                ...
                <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
                    <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                        <img src="img/pic6.jpg" height="100" width="200" class="w-100"/>
                        <a href="#!">
                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                        </a>
                    </div>
                ...
                <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
                    <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                        <img src="img/pic8.jpg" height="100" width="200" class="w-100"/>
                        <a href="#!">
                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                        </a>
                    </div>
                ...
                <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
                    <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                        <img src="img/pic9.png" height="100" width="200" class="w-100"/>
                        <a href="#!">
                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                        </a>
                    </div>
                ...
                <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
                    <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                        <img src="img/van1.jpg" height="100" width="200" class="w-100"/>
                        <a href="#!">
                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                        </a>
                    </div>
                ...
                <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
                    <div class="bg-image hover-overlay ripple shadow-1-strong rounded" data-ripple-color="light">
                        <img src="img/van6.jpg" height="100" width="200" class="w-100"/>
                        <a href="#!">
                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);"></div>
                        </a>
                    </div>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        ...
        <br>
        <a class="text-white" href="#">Powered by tourafrica.com</a>
    </div>
    <!-- Copyright -->
</footer>
