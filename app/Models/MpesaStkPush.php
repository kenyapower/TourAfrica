...
//        $this->consumer_key = "EdpGG9jdmcAjAwKze6ioGMjOOMp8mJ3j "; //Your Consumer key
//        $this->consumer_secret = " oHNKYh80EuSnqqW0"; //Your Secret key
...
//        $this->initiatorPassword = "Safaricom984!"; //Password of your choice
//
//    }
//
...
//$headers = ['Content-Type:application/json; charset=utf8'];
//
//$access_token_url = ($this->env == "live") ? "https://api.safaricom.co.ke/oauth/v2/generate?grant_type=client_credentials" : "https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials";
//$initiate_url = ($this->env == "live") ? "https://api.safaricom.co.ke/mpesa/stkpush/v2/processrequest" : "https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest";
//
//
//$curl = curl_init($access_token_url);
//curl_setopt($curl, CURLOPT_HTTPHEADER, $headers);
...
//$result = json_decode($result);
////            $result = d("", $result);
////            $result['access_token'] = json_decode($result);
//dd($result);
//$access_token = $result->$result['access_token'];
//curl_close($curl);
//
//# header for stk push
//$stkheader = ['Content-Type:application/json', 'Authorization:Bearer '];
////            $stkheader = ['Content-Type:application/json', 'Authorization:Bearer ' . $access_token];
//# initiating the transaction
//$curl = curl_init();
//curl_setopt($curl, CURLOPT_URL, $initiate_url);
...
//    'TransactionDesc' => $phoneNumber . " has paid " . $amount . " to " . $this->short_code
//);
//
//$data_string = json_encode($curl_post_data);
//curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
